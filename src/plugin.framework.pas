...
type
  ...
  public
    class function LoadPlugin<I: IInterface>(const ALibName, AFuncName: string): I;
...
class function TPlugInFrameWork.LoadPlugin<I>(const ALibName, AFuncName: string): I;
type
